...
export class IpcClient {
  ...
  public async restartCodeDuet(): Promise<void> {
  ...
  public async listMcpServers(): Promise<McpServer[]> {
    return this.ipcRenderer.invoke("mcp:listServers");
  }

  public async addMcpServer(config: McpServerConfig): Promise<McpServer> {
  ...
  public async deleteMcpServer(id: number): Promise<boolean> {
  ...
  public async testMcpConnection(config: McpServerConfig): Promise<boolean> {
    return this.ipcRenderer.invoke("mcp:testConnection", config);
  }

  public async getMcpTools(serverId?: number): Promise<McpTool[]> {
    return this.ipcRenderer.invoke("mcp:getTools", serverId);
  }
  ...
  public async getConnectedMcpServers(): Promise<number[]> {
    return this.ipcRenderer.invoke("mcp:getConnectedServers");
  }
