...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  ollama: [
    ...
    },
    {
      ...
      description: "Local general purpose model via Ollama",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
      temperature: 0,
      dollarSigns: 0,
  ...
  lmstudio: [
    {
      ...
      description: "Model served via LM Studio",
      maxOutputTokens: 32_000,
      contextWindow: 128_000,
      temperature: 0,
      dollarSigns: 0,
...
> = {
  ...
  vertex: {
    ...
    // Use the same gateway prefix as Google Gemini for CodeDuet Pro compatibility.
    gatewayPrefix: "gemini/",
    secondary: true,
  },
  openrouter: {
  ...
  runpod: {
    displayName: "RunPod",
    hasFreeTier: false,
    websiteUrl: "https://www.runpod.io/serverless",
    gatewayPrefix: "runpod/",
  },
  auto: {
    displayName: "Dyad",
    websiteUrl: "https://academy.codeduet.com/settings",
    gatewayPrefix: "dyad/",
  },
  azure: {
