...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/codeduet/codeduet-ai-agent/issues/880
  ".py",
  // https://github.com/codeduet/codeduet-ai-agent/issues/1221
  ".php",
];
...
//
// ex: https://github.com/codeduet/codeduet-ai-agent/issues/727
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<codeduet-file path="${normalizedRelativePath}">
