...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: " Get CodeDuet Pro",
      url: "https://codeduet.com/pro#ai",
    },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "CodeDuet Pro's Smart Context",
      url: "https://codeduet.com/pro#ai",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.codeduet.com/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.codeduet.com/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.codeduet.com/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.codeduet.com/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.codeduet.com/docs/roadmap",
    },
  ],
};
